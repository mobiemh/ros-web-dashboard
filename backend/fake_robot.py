#!/usr/bin/env python3
"""
GUI/실물 로봇 없이 테스트하기 위한 최소 ROS 2 노드.
- /odom (nav_msgs/Odometry) 를 10Hz 로 발행 (기본 원운동)
- /cmd_vel (geometry_msgs/Twist) 를 구독해 대시보드 조작을 반영
실제 로봇/시뮬(TurtleBot3 등)로 바꾸면 이 노드만 빼면 됨.
"""
import math
import rclpy
...
class FakeRobot(Node):
    def __init__(self):
        ...
        self.get_logger().info('fake_robot up: /odom 발행, /cmd_vel 구독')
